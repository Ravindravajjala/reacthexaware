...
function AddNewReview1() {
  ...
  const readOnlyEmail = localStorage.getItem('loggedInEmail'); // Check if email is loaded from localStorage
      ...
      <div className="form-group row">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            readOnly={readOnlyEmail !== null} // Set input field as readOnly if email is loaded from localStorage
          />
